<?php
  require('config/db.php');
	...
	if(isset($_POST['submit'])) {
		...
		$msg.= "Invalid name format(Only letters and white space allowed)<br>";
		$flag=1;
		}
...
<input  type="text" pattern="[0-9]{6}" title="Please enter a six digit pincode" id="Pincode" name="pincode" class="form-control" placeholder="Pincode" value="<?php echo $flag==1 ? $pincode : ''; ?>" required autofocus="">
...
<p>Do you want to become an environmentalist?(yes/no)</p>
